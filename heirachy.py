...
def app():
    ...
    st.header("Overview")
    st.write("This project addresses the challenge of efficiently generating an object hierarchy from images or videos, a process that \
        ...
        overlapping bounding boxes obtained from object detection results."
    )
    st.write("The proposed approach simplifies the understanding of object relationships by establishing parent-child associations \
    ...
    st.image("assets/methods/6_hierachy-1.png", caption="Flowchart of the Process of Object Detection and Hierarchy Establishment")

    st.header("Use Cases")
    st.image("assets/methods/6_hierachy-2.jpg", caption="An experimental result on single base object")
    st.image("assets/methods/6_hierachy-3.jpg", caption="An experimental result on multiple common base objects")