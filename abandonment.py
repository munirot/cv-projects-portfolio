...
def app():
    ...
    overview = """
        <p class="font txtAlign">
            Object abandonment detection in real-world CCTV footage has been challenging due to diverse and complex conditions, \
    ...
    method = """
        <p class="font txtAlign">
            Our methodology for detecting abandoned objects in video frames involves two primary stages: \
        object detection and tracking, and distance estimation. In the first stage, we used the custom YOLOv8 object detection model to identify and localize objects,\
    ...
    st.image("assets/methods/new_3_abandonment.png", caption="Methodology Flowchart")
