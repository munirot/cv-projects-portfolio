...
def app():
    ...
    overview = """
        ...
        <p class="font txtAlign"> Our approach enables the system to visualize detected collisions through OpenCV, offering an intuitive representation of \
    ...
    method = """
        <p class="font txtAlign">
        The system processes real-time video footage obtained from CCTV cameras. Video frames are preprocessed using OpenCV, \
    ...
    st.image("assets/methods/new_8_traffic.png", caption="Methodology Flowchart")
